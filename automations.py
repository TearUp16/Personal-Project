...
if selected_task == "ENDORSEMENT":
    if selected_category == "FORECLOSURE":
        ...
        if selected_fcl_page == "PIF PLACEMENT":
            fcl_placements()
        elif selected_fcl_page == "FOR INPUT DATA IN FCL DRIVE":
            fcl_drive_for_input()
        elif selected_fcl_page == "FOR INPUT DATA IN 2ND FCL DRIVE":
            fcl_2nd_drive_for_input()
        elif selected_fcl_page == "PIF LEGAL MAPPING":
            pif_legal_mapping()
        elif selected_fcl_page == "PIF LEGAL WEBSITE IMPORT FILE":
